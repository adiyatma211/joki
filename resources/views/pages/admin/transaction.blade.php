            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-6">
                        ...
                        <h1 class="mb-0 fw-bold">All Transaction</h1>
                    </div>
                                ...
                                <table class="table table-bordered table-hover" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($t->status == '3')
                                                    <button class="btn btn-success btn-sm" id="button-confirm">Confirmed</button>

                                                @endif

                                                @if ($t->status == '2')
                                                    <button class="btn btn-warning btn-sm" id="button-cancel" >Need Cnfirmation</button>

                                                @endif

                                                @if ($t->status == '4')
                                                    <button class="btn btn-danger btn-sm" id="button-cancel" >Canceled</button>
